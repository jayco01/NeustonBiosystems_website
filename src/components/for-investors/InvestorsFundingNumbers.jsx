export default function InvestorsFundingNumbers() {
    return (
        <section className="fluid-layout-padding bg-neuston-Amber-Lighter text-neuston-Amber-Darkest flex flex-col md:flex-row md:gap-20 gap-6">
