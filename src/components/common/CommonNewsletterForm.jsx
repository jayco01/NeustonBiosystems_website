export default function CommonNewsletterForm() {
    // URL will be replaced ones Scott Finish signing up for BREVO
    const BREVO_ACTION_URL = "Awaiting for Brevo Account";
    //https://assets.brevo.com/jsonp/unique_id/forms/form_id/subscribe
        ...
        <section className="fluid-layout-padding bg-neuston-Amber-Lighter text-neuston-Amber-Darkest flex flex-col items-center gap-3">
            ...
            <div>
                ...
                >
                    <input
                        type="email"
                        name="fields[email]" // Email Input name will be replaced ones Scott Finish signing up for BREVO
